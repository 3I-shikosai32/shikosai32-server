...
import { ItemCompletedHistoryOrderByInput } from '../../item-completed-history/item-completed-history-order-by/input';
...
export class CharacterStatusOrderByWithRelationInput {
    ...
    @Field(() => ItemCompletedHistoryOrderByInput, {nullable:true})
    itemCompletedHistory?: ItemCompletedHistoryOrderByInput;
}

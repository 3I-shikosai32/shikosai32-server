...
export interface UserReaderUseCaseInterface {
  ...
  getRankingPosition(userId: string, date: RankingPeriod): Promise<number>;
  getRanking(rankingTarget: keyof typeof RankingTarget, date: keyof typeof RankingPeriod, take?: number): Promise<Ranking[]>;
